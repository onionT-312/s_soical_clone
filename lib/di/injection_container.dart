...
import 'package:s_social/core/data/data_source/user_list_data_source.dart';
...
import '../core/data/repository/user_list_repository_impl.dart';
...
Future<void> initializeDependencies() async {
  ...
  serviceLocator.registerLazySingleton(() => UserListDataSource());
  ...
  serviceLocator.registerLazySingleton<UserListRepository>(
    () => UserListRepositoryImpl(userListDataSource: serviceLocator()),
  );
}

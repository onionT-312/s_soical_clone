...
class S {
  ...
  /// `You sent some images`
  String get you_sent_some_images {
    return Intl.message(
      'You sent some images',
      name: 'you_sent_some_images',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Can not share this post`
  String get can_not_share_this_post {
    return Intl.message(
      'Can not share this post',
      name: 'can_not_share_this_post',
      desc: '',
      args: [],
    );
  }
